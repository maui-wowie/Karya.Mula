                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-lg sm:rounded-2xl border border-gray-100">
                        ...
                        <form onSubmit={handleSubmit} className="p-8">
                            ...
                            {/* Keamanan */}
                            <div className="mb-8">
                                <h4 className="text-lg font-semibold text-bluey mb-2 flex items-center gap-2">
                                    <div className="w-8 h-8 bg-bluey-light rounded-lg flex items-center justify-center">
                                        <Lock
                                            size={18}
                                            className="text-bluey"
                            ...
                            <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
                                ...
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="px-6 py-2.5 rounded-lg bg-orange-500 hover:bg-orange-600 text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-lg shadow-orange-500/30"
                                >
                                    {processing ? (
